...
void PrescribedRotation1DOF::UpdateState(uint64_t callTime) {
    ...
    if (this->spinningBodyInMsg.timeWritten() <= callTime && this->convergence)
    {
        ...
        if (this->thetaRef != this->thetaInit) {
...
void PrescribedRotation1DOF::computeBangCoastBangParametersNoSmoothing() {
    ...
    this->theta_tb1 = sign * 0.5 * this->thetaDDotMax * this->coastOptionRampDuration
                         * this->coastOptionRampDuration + this->thetaInit;
    this->thetaDot_tb1 = sign * this->thetaDDotMax * this->coastOptionRampDuration;
...
void PrescribedRotation1DOF::computeSmoothedBangCoastBangParameters() {
    ...
    // Determine the hub-relative position and velocity at time t_b1
    this->thetaDot_tb1 = sign * this->thetaDDotMax * this->coastOptionRampDuration + this->thetaDot_ts1;
    this->theta_tb1 = sign * 0.5 * this->thetaDDotMax * this->coastOptionRampDuration
                         * this->coastOptionRampDuration + this->thetaDot_ts1 * this->coastOptionRampDuration
                         + this->theta_ts1;
    ...
    // Determine the hub-relative position and velocity at time t_b2
    this->thetaDot_tb2 = - sign * this->thetaDDotMax * this->coastOptionRampDuration + this->thetaDot_ts3;
    this->theta_tb2 = - sign * 0.5 * this->thetaDDotMax * this->coastOptionRampDuration
                         * this->coastOptionRampDuration + this->thetaDot_ts3 * this->coastOptionRampDuration
                         + this->theta_ts3;
...
/*! This method computes the first bang segment scalar rotational states.
 @return void
 @param t [s] Current simulation time
*/
...
/*! This method computes the second bang segment scalar rotational states.
 @return void
 @param t [s] Current simulation time
*/
...
void PrescribedRotation1DOF::computeThirdSmoothedSegment(double t) {
    ...
    if (this->coastOptionRampDuration > 0.0) {
        ...
        this->thetaDDot = - sign * this->thetaDDotMax * (term1 - term2);
        this->thetaDot = this->thetaDDot * (term3 - term4) + this->thetaDot_tc;
        this->theta = this->thetaDDot * (term5 - term6) + this->thetaDot_tc * (t - this->t_c) + this->theta_tc;
    } else {
