...
//                spiceInMsgID[k].dataFresh = false;
...

    {
        ...
        if (this->liveStream || (this->noDisplay && opNavModeStatus)) {
            // Receive pong
            /*! - The viz needs 10 images before placing the planets, wait for 11 protobuffers to have been created before attempting to go into noDisplay mode */
